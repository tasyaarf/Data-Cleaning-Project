...
According to the business request company want to know the current condition of world-layoff from various company around the world. 

### Data Source
The primary dataset used for this analysis is the "world_layoffs.csv" file, containing detailed information about each information regarding the company.

### Data Cleansing and Transformation 
The process includes:
   1. Data loading and inspection regarding duplicates data
   2. Data Standarization which include change the apropriate data type
   3. Handle the null and blank values
   4. Remove unuseful row/column
The cleaned data can be seen on "world_layoffs_cleaned.csv" files
...
## References
-http://www.youtube.com/@AlexTheAnalyst
